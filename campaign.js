...
const CHAPTERS = [
  ...
  },
  {
    ...
    map: {
      ...
      war: { owners: { '15,8': 1 }, names: { '15,8': 'ROCKET CENTER' } },
  ...
  },
  {
    ...
    map: {
      ...
      war: { owners: { '16,6': 1 }, names: { '16,6': 'ROCKET CENTER' } },
      rows: [
        '..t..~~~~~~~~..TT.',
        '.C...~~~~~~~~~..T.',
        '.....s~~~~~~~s..,.',
  ...
  },
  {
    ...
    map: {
      ...
      war: { owners: { '14,5': 1 }, names: { '14,5': 'ROCKET CENTER' } },
      rows: [
        'bbbbbbbbbbbbbbbbbb',
        'bffffxfbfffffpffbb',
        'bffffxfbffxfffffbb',
  ...
  },
  {
    ...
    map: {
      ...
      war: { owners: { '16,7': 1 }, names: { '16,7': 'ROCKET CENTER' } },
      rows: [
  ...
  },
  {
    ...
    map: {
      ...
      war: { owners: { '15,6': 1 }, names: { '15,6': 'ROCKET CENTER' } },
      rows: [
        'WWWWWWWWWWWWWWWWWW',
        'WKccLLLcccLLcccrcW',
        'WcrcLLccrcLLcLccLW',
  ...
  },
  {
    ...
    map: {
      ...
      war: { owners: { '16,9': 1 }, names: { '16,9': 'ROCKET CENTER' } },

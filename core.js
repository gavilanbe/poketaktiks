...
const Audio = {
  ...
  sfx(name) {
    ...
    switch (name) {
      ...
      case 'coin': this.tone('square', 988, 988, .05, .07); this.tone('square', 1319, 1319, .14, .07, .05); break;
...
const SONGS = {
  ...
  // the route map: an upbeat walk in C major
  route: { bpm: 118, len: 32, bass: notes('c3 . g2 . c3 . g2 . f2 . c3 . f2 . c3 . c3 . e3 . a2 . e3 . g2 . d3 . g2 . b2 .'), lead: notes('g4 . c5 . e5 . d5 c5 a4 . c5 . f5 . e5 d5 e5 . g5 . c6 . b5 a5 g5 . e5 . d5 . c5 .'), arp: notes('c5 e5 g5 e5 c5 e5 g5 e5 f5 a5 c6 a5 f5 a5 c6 a5 e5 g5 c6 g5 a5 c6 e6 c6 g5 b5 d6 b5 g5 b5 d6 b5'), drum: [2, 0, 1, 0, 2, 0, 1, 1, 2, 0, 1, 0, 2, 0, 1, 1, 2, 0, 1, 0, 2, 0, 1, 1, 2, 0, 1, 0, 2, 1, 2, 1] },

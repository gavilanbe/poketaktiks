...
<script>
H
cat core.js font.js dex.js data.js animmeta.js art.js model.js captain.js battle.js duel.js campaign.js territory.js scenes.js title.js journey.js main.js
cat <<'H'
</script>
</body>
</html>
